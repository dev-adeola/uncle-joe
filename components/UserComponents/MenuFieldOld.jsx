...
import { Box, Divider, FormControl, Menu, MenuItem, Stack, TextField } from '@mui/material';
import React, { useState } from 'react'

function MenuField({ options, value, setValue, label, width = 360, placeholder = 'Select Category' }) {
    ...
    return (
        ...
        >
            <Box
                ...
                onClick={openOptions}
                className="w-full rounded border border-border p-2 flex items-center justify-start cursor-pointer"
            >
                {value ? (
