...
function OfferExchangeRate({
  ...
  //   dispatch(setRate(exchangeRateInfo.rateInPercentage - 0.5));
  // };
  // //
  ...
  // };
  // //
  // const [rateInPercentage, setRateInPercentage] = useState(-2.5);
  // const handleInput = (e) => {
  //   // dispatch(setRate(Number(e.target.value)));
  //   setRateInPercentage(Number(e.target.value));
  // };
    ...
    <>
      <div className="h-fit w-full transition-all duration-500 max-w-[1052px] space-y-4 rounded-[10px] bg-secondary p-4  md:p-6">
        ...
        <div className="flex items-center space-x-4 md:space-x-6">
          {/* <CustomRateButton
            label={"Market rate"}
            selected={exchangeRateInfo?.rateType === "market"}
            setSelected={() => dispatch(selectRateType("market"))}
          />
          <CustomRateButton
            label={"Fixed Rate"}
            selected={exchangeRateInfo?.rateType === "fixed"}
            setSelected={() => dispatch(selectRateType("fixed"))}
          /> */}
        </div>
        <CustomRateButton
...
export default OfferExchangeRate;
